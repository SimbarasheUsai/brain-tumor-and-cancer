...
import flet
from flet import AppBar, ElevatedButton
...
from layout_and_function import *

if __name__ == "__main__":

    def main(page: Page, title="CANCER AND TUMOR APP"):
        k = MainApp(page)
        ...
        pages = [
            (
                dict(icon=icons.HOME, selected_icon=icons.HOME, label="HOME"),
                k,)    
        ...
        menu_layout.navigation_rail.leading = Text("MENU")
